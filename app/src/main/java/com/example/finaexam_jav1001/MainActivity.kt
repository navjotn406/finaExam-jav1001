...
import com.example.finaexam_jav1001.R
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mynumber = findViewById<EditText>(R.id.mynum)
        val btn1 = findViewById<Button>(R.id.button1)
        val btn2 = findViewById<Button>(R.id.button2)
        val textview1 = findViewById<TextView>(R.id.ans1)
        val textview2 = findViewById<TextView>(R.id.ans2)
